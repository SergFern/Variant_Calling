...
def bam_name = "wochr.bam"
def region_interval = "-L ${params.region_intervals}"
...
if(!params.GVCFmode){
  ...
  Channel
    .fromFilePairs("${params.BAM_input_dir}/${samplePrefix}*{${bam_name},${bam_name}.bai}", size : 2, type: "any")
  ...
  process Variant_Calling_single {
    ...
    if(params.common_id == '*'){
      Channel
        .fromFilePairs("${BAM_input_dir}/${samplePrefix}*{${bam_name},${bam_name}.bai}", size : 2, type: "any", checkIfExists: true)
      ...
      Channel
        .fromFilePairs("${BAM_input_dir}/${samplePrefix}*{${bam_name},${bam_name}.bai}", size : 2, type: "any")
